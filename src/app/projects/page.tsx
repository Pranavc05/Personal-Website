...
export const metadata = {
  ...
  description: 'Featured projects including KAI, DataForge, AutoSlate, DocuSynth AI, and Worksheet Generator - production systems that solve real-world problems.',
  openGraph: {
    title: 'Projects | Pranav Chandrasekhar',
    description: 'Featured projects including KAI, DataForge, AutoSlate, DocuSynth AI, and Worksheet Generator - production systems that solve real-world problems.',
  },
